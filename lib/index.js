...
var Main = (function () {
    ...
    Main.runNgBuild = function (watch) {
        ...
        return new Promise(function (resolve, reject) {
            var proc = childProcess.exec("ng build --watch=" + watch + " --output-path=bundle", { maxBuffer: maxBuffer }, function (error, stdout, stderror) {
                if (error) {
    ...
    Main.preparePackageJson = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Main.prepareAngularCliConfig = function () {
        return __awaiter(this, void 0, void 0, function () {
            var angularCliConfig, _a, _b, _c, electronAsset;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        console.log('preparing angular-cli.json');
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, mz_1.fs.readFile(this.angularCliJsonPath, 'utf-8')];
                    case 1:
                        angularCliConfig = _b.apply(_a, [_d.sent()]);
                        if (!angularCliConfig.apps[0].assets) {
                            angularCliConfig.apps[0].assets = [];
                        }
                        electronAsset = { glob: "**/*", input: "./electron/", output: "./" };
                        angularCliConfig.apps[0].assets.push(electronAsset);
                        angularCliConfig.apps[0].outDir = "bundle";
                        return [4 /*yield*/, mz_1.fs.writeFile(this.angularCliJsonPath, JSON.stringify(angularCliConfig, null, 2))];
                    case 2:
                        _d.sent();
                        return [2 /*return*/];
                }
    ...
    Main.createElectronEntryPoint = function () {
        return __awaiter(this, void 0, void 0, function () {
            var targetDir, sourcePath, targetPath, template;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        console.log('creating entry point');
                        targetDir = path.join('src', 'electron');
                        if (!mz_1.fs.existsSync(targetDir)) {
                            mz_1.fs.mkdirSync(targetDir);
                        }
                        sourcePath = path.join(__dirname, '..', 'res', 'electron-main.js.template');
                        targetPath = path.join(targetDir, 'electron.js');
    ...
    Main.modifyWebpackConfig = function (packageJson) {
        return __awaiter(this, void 0, void 0, function () {
            var originalConfig, nativeDependencies, externalsTemplate, externals, newConfig, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, mz_1.fs.readFile(path.join(__dirname, '..', 'res', 'externals.template'), 'utf-8')];
                    case 3:
    ...
    Main.installNativeDependenciesIntoBuild = function (packageJson) {
        return __awaiter(this, void 0, void 0, function () {
            var packagesToInstall, _i, _a, packageName, error_6;
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.preparePackageJson()];
                    case 3:
                        _a.sent();
...
Main.configPath = path.join(__dirname, '..', '..', '@angular', 'cli', 'models', 'webpack-configs', 'common.js');
Main.copyConfigPath = path.join(__dirname, '..', '..', '@angular', 'cli', 'models', 'webpack-configs', 'common.original.js');
Main.angularCliJsonPath = '.angular-cli.json';
Main.main();
